import { ResizablePanel, ResizablePanelGroup } from "../shared/ResizablePanels";
  ...
  return (
    <div className="relative rounded-lg flex-1  overflow-hidden h-full">
      ...
      >
        <ResizablePanel
          defaultSize={50}
          className="bg-primary-500 opacity-40  rounded-l-lg backdrop-brightness-75  backdrop-saturate-150 backdrop-contrast-150 w-[110%]"
        />
